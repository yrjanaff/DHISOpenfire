...
public class UserManager implements IQResultListener {
    ...
    {
        Log.debug("Username in UserManager: " + username);
        Log.debug("Provider in UserManager: " + provider);
        ...
        Log.debug("Kom forbi alle ifer i UserManager!");
        ...
        Log.debug("Skal til å returnere i UserManager. User: " + user);
        return user;
    }
